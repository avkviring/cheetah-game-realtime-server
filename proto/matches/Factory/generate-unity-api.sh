...
docker run --rm -v$project_dir:/tmp/source -w /tmp/source/proto/matches/Factory akviring/protoc:latest \
  ...
  --grpc_out=/tmp/source/clients/Unity/Packages/games.cheetah.matches.factory/Editor/GRPC \
  --csharp_out=/tmp/source/clients/Unity/Packages/games.cheetah.matches.factory/Editor/GRPC \
