...
namespace Games.Cheetah.Client.ServerAPI.FFI
{
    public class StructureServerAPI : IStructureServerAPI
    {
        ...
        public byte Set(ushort clientId, in CheetahObjectId objectId, ushort fieldId, ref CheetahBuffer data)
        {
            return StructureFFI.Set(clientId, in objectId, fieldId, ref data);
        }
        ...
        {
            return StructureFFI.CompareAndSet(clientId, in objectId, fieldId, ref currentValue, ref newValue, hasReset, ref resetValue);
        }
    }
}