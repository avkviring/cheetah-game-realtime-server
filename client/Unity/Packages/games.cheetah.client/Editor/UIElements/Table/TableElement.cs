...
namespace Games.Cheetah.Client.Editor.UIElements.Table
{
    /// <summary>
    ...
    public class TableElement : VisualElement
    {
        ...
        {
            var uiAsset =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Packages/games.cheetah.client/Editor/UIElements/Table/TableElement.uxml");
