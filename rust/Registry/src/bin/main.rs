...
use cheetah_registry::proto::matches::registry::internal::registry_server::RegistryServer;
use cheetah_registry::registry::service::RegistryService;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	Server::builder()
		...
		.serve(cheetah_microservice::get_internal_grpc_service_default_address())
		.await?;
	Ok(())
}
