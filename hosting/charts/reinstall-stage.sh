...
helm -n $1 upgrade --install $1 Platform -f Platform/values-dev.yaml --set global.grpcDomain=$1.stage.cheetah.games --set global.platformImageVersion=$2 --wait-for-jobs --wait
