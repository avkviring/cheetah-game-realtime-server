...
namespace Games.Cheetah.Client.Editor.DumpViewer.Sections.Objects
{
    public class ObjectsViewer : VisualElement
    {
        ...
        public ObjectsViewer(StatusIndicator statusIndicator)
        {
            ...
            var uiAsset =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Packages/games.cheetah.client/Editor/DumpViewer/Sections/Objects/Panel.uxml");
