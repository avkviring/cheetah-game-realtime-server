...
namespace Games.Cheetah.Client.Editor.UIElements.HistoryTextField
{
    /// <summary>
    ...
    public class HistoryTextField : VisualElement
    {
        ...
        {
            var uiAsset =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Packages/games.cheetah.client/Editor/UIElements/HistoryTextField/HistoryTextField.uxml");
