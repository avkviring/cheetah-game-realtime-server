...
use crate::protocol::frame::applications::{ApplicationCommandChannel, ApplicationCommandDescription, ApplicationCommands};
...
impl OutCommandsCollector {
	...
	pub fn add_command(&mut self, command: ApplicationCommandDescription) {
		let commands = match command.channel {
