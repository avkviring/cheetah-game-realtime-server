...
namespace Games_Cheetah_Client_Tests_Codec_Field
{
		...
		// warning warning warning warning warning
		public class TestCodecArrayFieldInnerCodec:Codec<Games.Cheetah.Client.Tests.Codec.Field.TestCodecArrayField.Inner>
		{
			public void Decode(ref NetworkBuffer buffer, ref Games.Cheetah.Client.Tests.Codec.Field.TestCodecArrayField.Inner dest)
			{
				dest.value = IntFormatter.Instance.Read(ref buffer);
			}
	
			public void  Encode(in Games.Cheetah.Client.Tests.Codec.Field.TestCodecArrayField.Inner source, ref NetworkBuffer buffer)
			{
