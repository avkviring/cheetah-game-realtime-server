...
namespace Cheetah.Matches.Realtime.Editor.UIElements.NetworkAddress
{
    /// <summary>
        ...
        public NetworkAddress()
        {
            VisualTreeAsset uiAsset =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                    "Packages/games.cheetah.matches.realtime/Editor/UIElements/NetworkAddress/NetworkAddress.uxml");
