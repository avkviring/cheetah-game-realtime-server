...
# macos
cp target/debug/libcheetah_client.dylib "$UnityProject/Packages/games.cheetah.client/Runtime/Library/libcheetah_client.bundle"
...
cp target/debug/libcheetah_embedded.dylib "$NetProject"
