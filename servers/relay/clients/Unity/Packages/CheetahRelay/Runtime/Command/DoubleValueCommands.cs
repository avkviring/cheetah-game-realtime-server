...
{
    public static class DoubleValueCommands
    {
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void Listener(ref CommandMeta meta, ref RelayObjectId objectId, ushort fieldId, double value);
        ...
        public static extern bool Set(ref RelayObjectId objectId, ushort fieldId, double value);
        ...
        public static extern bool Increment(ref RelayObjectId objectId, ushort fieldId, double increment);
    }
}