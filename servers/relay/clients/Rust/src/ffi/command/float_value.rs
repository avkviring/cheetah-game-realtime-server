...
#[no_mangle]
pub extern "C" fn set_float_value_listener(listener: extern "C" fn(&S2CMetaCommandInformation, &GameObjectIdFFI, FieldIdType, f64)) -> bool {
...
#[no_mangle]
pub extern "C" fn set_float_value(object_id: &GameObjectIdFFI, field_id: FieldIdType, value: f64) -> bool {
...
#[no_mangle]
pub extern "C" fn inc_float_value(object_id: &GameObjectIdFFI, field_id: FieldIdType, increment: f64) -> bool {
