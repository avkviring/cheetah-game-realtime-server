...
use cheetah_relay::room::objects::object::{FieldID, GameObject, GameObjectTemplate, GroupType};
...
fn setup() -> GameObject {
	GameObject::new_client_object(&client_stub(0), 0, &game_object_template_stub())
}


pub fn game_object_template_stub() -> GameObjectTemplate {
	GameObjectTemplate {
...
pub fn game_object_template_stub_with_group(group: GroupType) -> GameObjectTemplate {
	GameObjectTemplate {
		long_counters: Default::default(),
		float_counters: Default::default(),
		structures: Default::default(),
