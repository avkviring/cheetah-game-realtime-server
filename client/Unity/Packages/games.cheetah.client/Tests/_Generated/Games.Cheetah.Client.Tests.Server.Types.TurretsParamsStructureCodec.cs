...
namespace Games_Cheetah_Client_Tests_Server_Types
{
		...
		// warning warning warning warning warning
		public class TurretsParamsStructureCodec:Codec<Games.Cheetah.Client.Tests.Server.Types.TurretsParamsStructure>
		{
			public void Decode(ref NetworkBuffer buffer, ref Games.Cheetah.Client.Tests.Server.Types.TurretsParamsStructure dest)
			{
				dest.Speed = DoubleFormatter.Instance.Read(ref buffer);
				dest.Damage = DoubleFormatter.Instance.Read(ref buffer);
			}
	
			public void  Encode(in Games.Cheetah.Client.Tests.Server.Types.TurretsParamsStructure source, ref NetworkBuffer buffer)
			{
