...
namespace Games.Cheetah.Client.Editor.DumpViewer.Sections.Users
{
    public class UsersViewer : VisualElement
    {
        ...
        {
            var uiAsset =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Packages/games.cheetah.client/Editor/DumpViewer/Sections/Users/Panel.uxml");
