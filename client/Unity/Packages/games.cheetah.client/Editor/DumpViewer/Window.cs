...
using Games.Cheetah.Client.Editor.UIElements;
...
namespace Games.Cheetah.Client.Editor.DumpViewer
{
    /// <summary>
    ...
    public class DumpViewerWindow : EditorWindow
    {
        ...
        private const string PathToUxml = "Packages/games.cheetah.client/Editor/DumpViewer/UI/Window.uxml";
